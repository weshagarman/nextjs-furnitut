...
export async function login(formData: FormData) {
  ...
  await mailer(
    ...
    {
      html: `<a href=${process.env.NEXT_PUBLIC_CANONICAL_URL}/orders/verify?token=${token}">Click here to log in</a>`,
      text: `Click here to log in: ${process.env.NEXT_PUBLIC_CANONICAL_URL}/orders/verify?token=${token}`,
    }
  );
